...
public class DatabaseDriver {
    ...
    public DatabaseDriver(){
        try{
            this.conn = DriverManager.getConnection("jdbc:sqlite:roappbanking.db");
    ...
    // Metoda returneaza soldul contului de economii
    ...
    // Metoda de adaugare sau scadere a soldului din cont
